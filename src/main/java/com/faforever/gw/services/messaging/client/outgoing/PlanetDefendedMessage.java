...
@Data
public class PlanetDefendedMessage extends AbstractOutgoingWebSocketMessage {
    private UUID planetId;
    private UUID battleId;
    private Faction attackingFaction;
    private Faction defendingFaction;

    public PlanetDefendedMessage(Collection<User> connectedUsers, UUID planetId, UUID battleId, Faction attackingFaction, Faction defendingFaction) {
