...
import com.faforever.gw.messaging.client.outbound.PlanetUnderAssaultMessage;
...
public class PlanetUnderAssaultNotification implements JavaDelegate {
    ...
    @Inject
    public PlanetUnderAssaultNotification(ClientMessagingService clientMessagingService) {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        clientMessagingService.sendToPublic(new PlanetUnderAssaultMessage(planetId, battleId, attackingFaction, defendingFaction));
    }
}
