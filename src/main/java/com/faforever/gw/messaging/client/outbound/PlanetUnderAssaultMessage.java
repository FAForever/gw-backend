...
@Data
public class PlanetUnderAssaultMessage extends OutboundClientMessage {
    private UUID planetId;
    private UUID battleId;
    private Faction attackingFaction;
    private Faction defendingFaction;

    public PlanetUnderAssaultMessage(UUID planetId, UUID battleId, Faction attackingFaction, Faction defendingFaction) {
